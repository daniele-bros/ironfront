...
- Villages are guarded by Iron Golems that hurl hostile mobs into the air; build your own by placing a carved pumpkin on a T of four iron blocks (one block, three in a row on top of it). Shear a pumpkin with shears to carve it; pumpkins grow in patches in plains, forests and swamps. Ancient cities lie in the deep dark far underground: deepslate ruins over sculk, with loot chests (Swift Sneak books among them) and sculk shriekers that hear you walk. Four shrieks wake the Warden, a blind 500-health giant that hunts by vibration, fires a sonic boom through walls and kills in two hits. Sneak, stand still, and it loses you.
