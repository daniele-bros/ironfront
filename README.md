...
- Structures also include woodland mansions (forests; three floors of rooms, loot and vindicators), ocean monuments (deep ocean; prismarine halls, sea lanterns, a sealed gold treasure room and laser-firing guardians) and shipwrecks (two sea-floor supply chests packed with iron ingots, raw iron, iron blocks and iron gear).
...
- Ruined nether portals appear roughly once per 300 blocks, always carry one or two gold blocks and chests heavy with gold gear and ingots.
...
- Shield (6 planks around an iron ingot): hold right-click to block. Hold it in your hand, or put it in the new Offhand slot and it blocks whenever your main hand holds a weapon, tool or nothing. A raised shield stops melee hits, arrows, fireballs, shulker bullets and explosions coming from the front, costs durability per hit and slows you while raised. A vindicator's axe knocks it aside for five seconds. Shields turn up in outposts and shipwrecks.
...
- Command console: press / (or T) in game for /give <item> [count] [enchant:level], /kit enchanting|end|netherite|diamond|food|builder, /build enchanting (places an enchanting table with 15 bookshelves in front of you), /tp x y z, /tp <village|desert_temple|igloo|swamp_hut|ruined_portal|mansion|monument|shipwreck|jungle_temple|stronghold|mineshaft|fortress|end_city|spawn_portal> to jump to the nearest one, /tp <diamonds|iron|gold|emerald|coal|lapis|redstone|debris> to land on top of the nearest ore, /locate <the same targets> to only print coordinates and direction, /time, /gamemode, /spawn, /heal, /xp, /kill and /help.
